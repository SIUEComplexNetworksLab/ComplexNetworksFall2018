...
Graph2::Graph2(const std::vector<std::vector<int> > &some_nodes)
{
	nodes = some_nodes;
...
Graph2::Graph2(const Graph2 &g, const vector<bool> &removed_set)
{
	orig_file = g.orig_file;
	original_mapping = g.original_mapping;
...
void Graph2::outputToGraph(string filename)
{
	ofstream myfile;
 ...
 void Graph2::removeNodes(vector<bool> &removed_set) {
 ...
 vector<int> Graph2::connectedComponents()
 {
 ...
 void Graph2::DFSUtil(int v, bool visited[], vector<int> & comps)
 {
